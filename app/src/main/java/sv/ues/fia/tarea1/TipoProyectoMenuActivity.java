...
public class TipoProyectoMenuActivity extends ListActivity {
    ...
    String[] opcionCrud={"Insertar Registro","Eliminar Registro","Consultar Registro",
            "Actualizar Registro"};
    String[] activities={"TipoProyectoInsertarActivity","TipoProyectoEliminarActivity","TipoProyectoConsultarActivity",
            "TipoProyectoActualizarActivity"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            Cursor c = helper.obtenerSubMenu(id,"03_");
            if(c!=null) {
                if (c.moveToFirst())
                    do {
